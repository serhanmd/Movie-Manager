...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<ListView>(R.id.list_view).adapter = ListAdapter(mainActivity, testMovieData)
        ...
        searchFilter.addTextChangedListener(object:TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                if (s?.isNotEmpty() == true) {
                    ...
                    findViewById<ListView>(R.id.list_view).adapter = ListAdapter(mainActivity,
